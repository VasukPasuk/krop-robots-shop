...
@Module({
  imports: [UsersModule, CategoriesModule, ProductsModule, VariantsModule, ConfigModule.forRoot({isGlobal: true}), ColorsModule, TagsModule, UsersFavouriteProductsModule, ProductsHaveTagsModule, ReviewsModule, OrdersModule, OrderItemsModule, CartsModule, CartItemsModule],
